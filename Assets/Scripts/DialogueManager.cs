...
public class DialogueManager : MonoBehaviour
{
    ...
    IEnumerator TypeSentence(string sentence)
    {
        ...
        {
            FindObjectOfType<AudioManager>().Play("Txt");
            message.text += letter;
    ...
    void ChangeName(string _speaker)
    {
        string SpeakerName = _speaker;
        nametag.text = SpeakerName;
    }
    
    void ChangeSound(string _sound)
    {
        string Soundtxt = _sound;
        nametag.text = Soundtxt;
    }
}